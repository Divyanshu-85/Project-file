...
if result:
    ...
    show_message(f"Access granted! Welcome, {input_username}")
    ...
    if option == "username":
        ...
        show_message("Username updated successfully!")
